<template>
		<div class="page-content-wrapper border">
			...
			<div class="row mb-3">
				<div class="col-12">
					<h1 class="h3 mb-0">My Loans History</h1>
				</div>
			</div>
					...
					<div class="table-responsive-xxl border-0">
						<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
							...
							<tbody>
								...
								<!-- Table row -->
								<tr v-for="(loan, i) in my_loans" :key="i">
								...
								<tr v-if="my_loans.length < 1">
									<td></td>
									<td>No active loans</td>
									<td></td>
								</tr>
...
methods: {
    async allLoans(){
      ...
      try {
        ...
        this.my_loans = await this.$axios.get(`customer/loans/${this.user.id}`).then(res => res.data)
